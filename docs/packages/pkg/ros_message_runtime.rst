...
-  `Example <https://github.com/cpp-pm/hunter/blob/master/examples/ros_message_runtime/CMakeLists.txt>`__
-  Added by
    - `Lukas Solanka <https://github.com/lsolanka>`__ (`pr-1439 <https://github.com/ruslo/hunter/pull/1439>`__)
