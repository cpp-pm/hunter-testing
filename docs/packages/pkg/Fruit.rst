...
-  `Versions <https://github.com/cpp-pm/hunter/blob/master/cmake/projects/Fruit/hunter.cmake>`__
-  `Example <https://github.com/cpp-pm/hunter/blob/master/examples/Fruit/CMakeLists.txt>`__
